...
(
    ...
    CONSTRAINT FK_PRODUIT_IDCLIENT FOREIGN KEY (IDCLIENT) REFERENCES CLIENT (IDCLIENT),
    ...
    CONSTRAINT CK_PRODUIT_SOLDE CHECK (SOLDE >= 0 AND SOLDE < 100),
