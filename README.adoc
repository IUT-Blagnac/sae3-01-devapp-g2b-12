...
- Version courante : {baseURL}/releases/tag/v0.1[v0.1]
- Lien vers les User Stories et Issues https://github.com/orgs/IUT-Blagnac/projects/23[ici], reste 100 %
...
** `bd` => document en lien avec la base de données
...
Tous les fichiers et répertoires du dossier racine doivent être téléversés sur le serveur hébergera votre site web.
