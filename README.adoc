...
Pour la partie Python les tests sont implémentés dans le script lui-même, {baseURL}/blob/master/app/python/main.py[ici], et expliquer dans sa documentation technique, {baseURL}/blob/master/docs/python/python_tech.adoc[ici].


=== PHP

Vous pouvez retrouver les test du site web {baseURL}/blob/master/tests/php/tests-php.adoc[ici].
