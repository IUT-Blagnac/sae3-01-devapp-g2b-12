...
Identifier les sprints.Identifier à quelle US se rattache une tâche.
...
Attention à partir de maintenant on ne fouille plus dans vos dépôts !

Il me manque donc les lies vers : les backlogs produits, les backlogs de sprint !!
