...
Tuteur/tutrice enseignant(e) de l'équipe:: mailto:teste@irit.fr[OT]
...
*** `build.yml` => un script pour build l'application
*** `tests.yml` => un script pour tester l'application
